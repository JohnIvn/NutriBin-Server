...
export default function About() {
  ...
  return (
    <div className="bg-[#ECE3CE]/20 min-h-screen font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 lg:py-24 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg text-[#739072] leading-relaxed mb-8 max-w-xl">
            An intelligent IoT ecosystem bridging the gap between household waste and sustainable agriculture. We transform organic food scraps into nutrient-rich fertilizer using high‑performance mechanics and real‑time analytics.
          </p>
          <div className="flex gap-4">
            <Button className="bg-[#3A4D39] hover:bg-[#4F6F52] text-white px-8 h-12 rounded-full font-bold cursor-pointer">
              Get Started
            </Button>
            <Button variant="outline" className="border-[#3A4D39] text-[#3A4D39] hover:bg-[#3A4D39]/10 px-8 h-12 rounded-full font-bold cursor-pointer">
              View Specs
            </Button>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative w-64 h-64 lg:w-80 lg:h-80 bg-white rounded-3xl shadow-2xl flex items-center justify-center p-8 border border-[#ECE3CE]">
            ...
            <img src="/Logo.svg" alt="NutriBin Logo" className="w-full h-full object-contain" />
          </div>
        </motion.div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-[#3A4D39] mb-4">Core Capabilities</h2>
          <p className="text-[#739072]">Engineered for efficiency, safety, and ease of use.</p>
        </div>
        ...
        >
          <motion.div variants={itemVariants}><FeatureCard icon={<Cpu />} title="Auto-Thermal Process" desc="Rapidly converts food scraps into stable fertilizer using a controlled cycle of mechanical mixing and optimized heating." /></motion.div>
          <motion.div variants={itemVariants}><FeatureCard icon={<Activity />} title="Smart NPK Profiling" desc="Integrated sensors analyze Nitrogen, Phosphorus, and Potassium levels, providing a digital Nutrient Card for every batch." /></motion.div>
          <motion.div variants={itemVariants}><FeatureCard icon={<Box />} title="Real‑time Monitoring" desc="Live tracking of machine health, including temperature and motor status, via ESP32‑powered web dashboards." /></motion.div>
          <motion.div variants={itemVariants}><FeatureCard icon={<Flame />} title="Safety & Gas Sensing" desc="MQ‑series sensors detect Ammonia and Methane levels, ensuring a safe and odor‑controlled environment." /></motion.div>
          <motion.div variants={itemVariants}><FeatureCard icon={<Leaf />} title="Batch History Logs" desc="Automatically logs every cycle so you can track nutrient quality and system performance remotely." /></motion.div>
          <motion.div variants={itemVariants}><FeatureCard icon={<Cog />} title="Automated Maintenance" desc="Self-diagnostic systems alert users to maintenance needs, ensuring longevity and consistent performance." /></motion.div>
        </motion.div>
      </section>
      ...
      <section className="bg-white py-20 border-y border-[#3A4D39]/10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-[#3A4D39] mb-2">How It Works</h2>
            <p className="text-[#739072]">From table scraps to garden gold in three steps.</p>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 space-y-12">
        ...
        >
          ...
          <div>
            <h3 className="text-xl font-bold text-[#3A4D39] mb-4">Safety & Usage Guidelines</h3>
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-center gap-3 text-sm text-[#4F6F52] font-medium">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#D97706]" /> {item}
                </li>
              ))}
            </ul>
          </div>
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to turn waste into life?</h2>
            <p className="text-[#ECE3CE] mb-8 text-lg">
              Connect your hardware, monitor batches, and join a community dedicated to science‑backed sustainability.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" className="border-[#ECE3CE]/30 text-[#ECE3CE] hover:bg-[#ECE3CE]/10 h-12 px-8 rounded-full">
                Browse Guides
              </Button>
            </div>
          </div>
