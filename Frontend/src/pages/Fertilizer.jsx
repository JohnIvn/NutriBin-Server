          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium focus:ring-2 focus:ring-[#4F6F52]/20 focus:border-[#4F6F52] outline-none transition-all cursor-pointer w-full"
              />
            </div>
            <Button
              variant="outline"
